...
//
//
//    public static  ArrayList<Resume_Entity> startProg(){
//        ArrayList<Resume_Entity> ff =  Parse_Connect.startConnectForParse();
//        //System.out.println(Arrays.asList(ff));
//    return ff;
//    }
//
//   // SessionFactory factory = new AnnotationConfiguration().configure().addAnnotatedClass(Resume_Entity.class).buildSessionFactory();
//
//
...
////                  try  (conn = DriverManager.getConnection(Constants.CONNECTION_URL);){
////                    Statement stmt = conn.createStatement();
////                    ResultSet rs = stmt.executeUpdate("INSERT INTO `parse_hh`.`resume_entity` (`age`, `local_time`, `position`, `url_site`, `was_time`) VALUES ('"+ageOnPageResume+"', '"+dateNow+"', '"+listTagSpanForFindPosition+"', '"+siteWebPages+"', '"+wasTime +"');");
