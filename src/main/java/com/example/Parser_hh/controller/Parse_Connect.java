...
public class Parse_Connect {
    ...
    public static void startConnectForParse() {

        try {
            Resume_Entity resumInformation = new Resume_Entity();
            ...
            for (int i = 0; i < 100; i++) {
                ...
                if (!listTagDivForFindWas.isEmpty()) {
                    String[] wasTime = listTagDivForFindWas.split("&nbsp;");
...
/////////////////////////////////////////////
            ...
            //Results save
//        resumInformation.setAge(ageOnPageResume);
//        resumInformation.setPosition(listTagSpanForFindPosition);
//        resumInformation.setUrl_site(SITE_URL_ID + splitResult0[0]);
//        resumInformation.setLocal_time(dateNow);
//        resumInformation.setWas_time(Arrays.toString(wasTime));
