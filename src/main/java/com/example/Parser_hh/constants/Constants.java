...
/* Дополнительные переменные для парсинга Itoe, SITE_URL_ID.*/
    ...
    String SITE_URL_ID = "https://hh.ru/resume/";// SITE_URL_ID - ссылка на резюме; Для открытия определенного резюме необходимо SITE_URL_ID + уникальное значение из атрибута href
